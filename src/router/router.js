    ...
    children: [
      {
        ...
        title: '公司简介',
        name: '1.1',
        component: () => import('@/views/JinJian-system/page1.1.vue')
      },
      {
        path: '1.2',
        title: '公司简介',
    ...
    children: [
      {
        ...
        title: '通道交易列表',
        name: '5.1',
        component: () => import('@/views/JinJian-system/page5.1.vue')

      },
      {
        path: 'search-cardTrans',
        title: '卡消费交易列表',
        name: '6.1',
        component: () => import('@/views/JinJian-system/page6.1.vue')

      },
      {
        path: 'search-reconBatch',
        title: '对账批次列表',
        name: '7.1',
        component: () => import('@/views/JinJian-system/page7.1.vue')

      },
      {
        path: 'search-reconMistake',
        title: '对账差错列表',
        name: '8.1',
        component: () => import('@/views/JinJian-system/page8.1.vue')

      },
      {
        path: 'search-reconMistakePool',
        title: '差错缓冲池列表',
        name: '9.1',
        component: () => import('@/views/JinJian-system/page9.1.vue')
      },
    ]
  },
*/
